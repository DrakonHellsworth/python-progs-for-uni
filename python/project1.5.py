...
def plot(event=None):                                                #This is a function to plot the graph
    ...
    try:                                                             # this function tries to execute the following code and if any error occurs it jumps to the except block
        ...
        if 'z' in st or 'y' in st:                                   #This checks if z or y is in the equation
            is_3d=True                                               #This sets is_3d to True
            ...
            is_3d=False                                              #This sets is_3d to False
            x=np.linspace(-10,10,500)                                    #This creates an array of 500 values between -10 and 10
            allowed={**allow,"x":x}                                        #This is a dictionary of allowed functions
            y=eval(st,allowed)                                        #This evaluates the string and stores it in y
